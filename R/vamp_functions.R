...
#' must match or the caller must provide explicit `blockSize`/`stepSize` that apply to all).
#' @param keys Character vector of plugin keys in "library:plugin" format.
